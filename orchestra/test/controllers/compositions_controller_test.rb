...
class CompositionsControllerTest < ActionController::TestCase
  ...
  test "should create composition" do
    assert_difference('Composition.count') do
      post :create, composition: { arranger: @composition.arranger, composer: @composition.composer, notes: @composition.notes, title: @composition.title }
    end
  ...
  test "should update composition" do
    patch :update, id: @composition, composition: { arranger: @composition.arranger, composer: @composition.composer, notes: @composition.notes, title: @composition.title }
    assert_redirected_to composition_path(assigns(:composition))
  end
